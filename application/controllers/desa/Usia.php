...
class Usia extends CI_Controller
{
    ...
    public function detail_data($id_usia)
    {
        ...
        $this->load->view('desa/template/header', $data);
        $this->load->view('desa/template/sidebar');
        $this->load->view('desa/data_penduduk/v_usia_detail', $data);
        $this->load->view('desa/template/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        $this->M_usia->insert_data($data, 'tb_usia');
