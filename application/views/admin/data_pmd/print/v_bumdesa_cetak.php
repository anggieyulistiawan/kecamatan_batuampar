...
<div class="container-fluid">
    ...
    <center>
        <table class="kop mb-5">
            <td style="font-size: 30px; font-weight: bold;"> Data Bumdesa di Kecamatan Batu Ampar </td>
        </table>
    </center>
    <br>
        ...
        <table class="isi" style="width:100%;">
            <thead style="line-height: 40px;">
                <tr>
                    ...
                    <th class="text-center">Nama Bumdesa</th>
                    <th class="text-center">Nomor Badan Usaha</th>
            ...
            <tbody style="line-height: 30px;" class="text-center">
                <?php $no = 1;
                foreach ($print_bumdesa as $k) : ?>
                    <tr>
                        <td><?php echo $no++ ?></td>
                        <!-- <td><?php echo format_indo(date($k->tanggal_bumdesa)); ?></td> -->
                        <td><?php echo $k->nama_desa ?></td>
                        <td><?php echo date('d-m-Y', strtotime($k->tgl_berdiri)); ?></td>
                        <td><?php echo $k->nama_bumdesa ?></td>
                        <td><?php echo $k->no_badan ?></td>
                        <td><?php echo $k->jenis_usaha ?></td>
                        <td><?php echo $k->alamat ?></td>
                        <td>Rp. <?php echo $k->modal_awal ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
