...
<div class="container-fluid">
    ...
    <center>
        <table class="kop mb-5">
            <td style="font-size: 30px; font-weight: bold;"> Data Perangkat Desa Berdasarkan BPD </td>
        </table>
    </center>
    <br>
    ...
    <div>
        <table class="isi" style="width:100%;">
            ...
            <tbody style="line-height: 30px;" class="text-center">
                <?php $no = 1;
                foreach ($print_bpd as $k) : ?>
                    <tr>
                        <td><?php echo $no++ ?></td>
                        <!-- <td><?php echo format_indo(date($k->tanggal_bpd)); ?></td> -->
                        <td><?php echo $k->nama_desa ?></td>
                        <td><?php echo $k->nama_bpd ?></td>
                        <td><?php echo date('d-m-Y', strtotime($k->tgllahir_bpd)); ?></td>
                        <td><?php echo $k->jabatan_bpd ?></td>
                        <td><?php echo $k->nosk_bpd ?></td>
                        <td><?php echo $k->periodeawal_bpd ?> - <?php echo $k->periodeakhir_bpd ?> Tahun</td>
                        <td><?php echo $k->telp_bpd ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
