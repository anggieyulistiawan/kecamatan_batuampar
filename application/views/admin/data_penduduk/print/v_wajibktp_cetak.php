...
<div class="container-fluid">
    ...
    <center>
        <table class="kop mb-5">
            <td style="font-size: 30px; font-weight: bold;"> Data Penduduk Berdasarkan Wajib KTP-EL </td>
        </table>
    </center>
    <br>
        ...
        <table class="isi" style="width:100%;">
            <tbody>
                <tr>
                    ...
                    <td style="text-align: center;" colspan="6">Keterangan</td>
                    <td style="text-align: center;" rowspan="3">JUMLAH</td>
                </tr>
                <tr>
                    <td style="text-align: center;" colspan="2">Jumlah Kartu Keluarga</td>
                    <td style="text-align: center;" colspan="2">Sudah Memiliki KTP-EL</td>
                    <td style="text-align: center;" colspan="2">Belum Memiliki KTP-EL</td>
                </tr>
                <tr>
                ...
                <?php $no = 1;
                foreach ($print_wajibktp as $p) : ?>
                    <tr>
                        <td style="text-align: center;"><?php echo $no++ ?></td>
                        <td><?php echo $p->nama_desa ?></td>
                        <td style="text-align: center;"><?php echo $p->jumlahkk_l ?></td>
                        <td style="text-align: center;"><?php echo $p->jumlahkk_p ?></td>
                        <td style="text-align: center;"><?php echo $p->sudahktpel_l ?></td>
                        <td style="text-align: center;"><?php echo $p->sudahktpel_p ?></td>
                        <td style="text-align: center;"><?php echo $p->belumktpel_l ?></td>
                        <td style="text-align: center;"><?php echo $p->belumktpel_p ?></td>
                        <td style="text-align: center;">
                            <?php echo $p->belumktpel_l + $p->sudahktpel_l + $p->jumlahkk_l + $p->belumktpel_p + $p->sudahktpel_p + $p->jumlahkk_p ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
