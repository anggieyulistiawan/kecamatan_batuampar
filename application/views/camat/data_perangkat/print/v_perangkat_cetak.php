...
<div class="container-fluid">
    ...
    <center>
        <table class="kop mb-5">
            <td style="font-size: 30px; font-weight: bold;"> Data Perangkat Desa Berdasarkan Kepala Desa </td>
        </table>
    </center>
    <br>
