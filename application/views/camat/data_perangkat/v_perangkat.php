...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h4 class="mb-4 text-gray-800">Data Perangkat Desa / <strong>Kelola Kepala Desa</strong></h4>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class=" btn-group">
                <div class=" btn-group">
                    <a class="btn btn-sm btn-primary m-0" href="<?php echo base_url('camat/print_perangkat') ?>">
                        <i class="fas fa-print"></i> Print</a>
                </div>
            </div>
            <div class=" btn-group">
                <form method="POST" action="<?= base_url('camat/perangkat/filter_perangkat'); ?>" class="form-inline">
