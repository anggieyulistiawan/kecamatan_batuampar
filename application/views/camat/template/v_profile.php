<div class="container-fluid">
    ...
    <form method="POST" action="<?php echo base_url('camat/profile/update_data_aksi/') ?>" enctype="multipart/form-data">
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body text-center" style="background-color: whitesmoke;">
                        <img class="img-account-profile embed-responsive rounded-circle mb-4 " width="200px" src="<?php echo base_url('/assets/foto/') . $this->session->userdata('foto') ?>" alt="">
