      ...
      <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <div class=" btn-group">
                      <div class=" btn-group">
                          <a class="btn btn-sm btn-primary m-0" href="<?php echo base_url('camat/print_bumdesa') ?>">
                              <i class="fas fa-print"></i> Print</a>
                      </div>
                  </div>
                  <div class=" btn-group">
                      <form method="POST" action="<?= base_url('camat/bumdesa/filter_bumdesa'); ?>" class="form-inline">
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <?php } else { ?>
                                          ...
                                          <a class="btn btn-sm btn-secondary" title="Views" href="<?php echo base_url('camat/bumdesa/detail_views/' . $b->id_bumdesa) ?>" target="_blank"><i class="fas fa-eye"></i> Views</a>
                                      <?php } ?>
                                  </td>
                              </tr>
                          </table>
