                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class=" btn-group">
                                <div class=" btn-group">
                                    <a class="btn btn-sm btn-primary m-0" href="<?php echo base_url('camat/print_jumlah') ?>">
                                        <i class="fas fa-print"></i> Print</a>
                                </div>
                            </div>
                            <div class=" btn-group">
                                <form method="POST" action="<?= base_url('camat/jumlah/filter_jumlah'); ?>" class="form-inline">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($jumlah as $p) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" title="Detail" href="<?php echo base_url('camat/jumlah/detail_data/' . $p->id_jumlah) ?>"><i class="fas fa-search-plus"></i> Detail</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
