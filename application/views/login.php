...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url() ?>assets/img/logo tala.png">

</head>

<body style="background-image: url('assets/img/1.jpeg');height: 100%;background-position: inherit;background-repeat: no-repeat;background-size: cover;">
							...
							<div class="col-lg-12">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900"><strong>Sistem Informasi </strong></h1>
										<h3 class="text-gray-900 mb-4">Kecamatan Batu Ampar</h3>
									</div>
